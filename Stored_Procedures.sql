...
-- tomando el camino correspondiente del ordenamiento mediante un condicional if. EJ: CALL INFORMACION_SERVIDOR(3,'ASC'), devuelve
-- la composicion del servidor ordenadas de manera ascendente conforme el nivel de la zona.
